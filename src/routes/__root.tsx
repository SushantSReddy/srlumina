...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Reps — JEE & NEET Question Tracker" },
      { name: "description", content: "Track questions solved daily by subject and source. Built for JEE and NEET aspirants." },
      { property: "og:title", content: "Reps — JEE & NEET Question Tracker" },
      { property: "og:description", content: "A minimalist tracker for daily practice. Log questions, tag your source, hit your goal." },
